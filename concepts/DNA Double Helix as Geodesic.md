...
The double helix is not an arbitrary shape—it may be a geodesic: the shortest path through a constrained [[State Space|geometric space]] defined by base-pairing, stacking energies, and backbone mechanics.
...
The space DNA "lives in" is not Euclidean 3-space but a higher-dimensional [[State Space|configuration space]] constrained by:
...
4. **Excluded volume** - Self-avoidance [[Constrained Dynamics|constraints]]

The accessible configurations form a submanifold. The [[Helical Structures in Biology|helix]] is the geodesic on this submanifold.
...
- **Mutations** are [[Perturbation-Response-Adaptation|perturbations]] off the geodesic (with energetic cost)
- **Evolution** is drift along the geodesic (sequence change) vs. off it (structural change)

The geodesic framework suggests that **[[Information Compression in Biology|information storage]] and geometric form are not independent**—the [[Helical Structures in Biology|helix]] is the optimal encoding geometry.

## Broader Implications

This connects to deeper questions:
- Why is [[Information Compression in Biology|biological information]] stored helically? (Also: α-helices, collagen triple helix)
- Is there a universal principle selecting [[Helical Structures in Biology|helical geodesics]] in molecular [[State Space|configuration spaces]]?
